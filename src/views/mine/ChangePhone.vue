<template>
  <div>
    ...
    <div class="formDiv">
      <mt-field placeholder="请输入手机号码" type="tel" v-model="form.mobile" class="logInput" :attr="{ maxlength: 11 }" @blur.native.capture="checkTel"></mt-field>
      ...
      <mt-field placeholder="原登录密码" type="password" v-model="form.password" class="logInput" :attr="{ maxlength: 18 }" @blur.native.capture="checkPwd"></mt-field>
