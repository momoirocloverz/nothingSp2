export default {
    ...
    formatPieceSize(data) {
        ...
        console.log(data)
        let content = (datas.jian == '' || datas.jian == '0' || datas.jian == undefined? '' : datas.jian + '件 ') +
            (datas.dai == '' || datas.dai == '0' || datas.dai == undefined ? '' : datas.dai + '袋 ') +
            (datas.che == '' || datas.che == '0' || datas.che == undefined ? '' : datas.che + '车 ') +
            (datas.dun == '' || datas.dun == '0' || datas.dun == undefined ? '' : datas.dun + '吨')
