    ...
    <div class="calendar">
        ...
        <tr v-for="(day,k1) in days" style="{'animation-delay',(k1*30)+'ms'}">
            <td v-for="(child,k2) in day" :class="{'selected':child.selected,'disabled':child.disabled}" @click="select(k1,k2,$event)">
                ...
                <!-- <div class="cicleGary" v-if="child.eventName!=undefined">{{child.eventName}}</div> -->
                ...
                <div class="cicleGary" v-if="child.eventName!=undefined && child.eventName == 1"></div>
                <div class="cicleRed" v-if="child.eventName!=undefined && child.eventName == 2"></div>
